...
<template>
    <div>
        ...
        <a v-bind:href="url">Link</a><br /> <!-- Equal to <a v-bind="attr">Link</a>  ;   attr = {href: url} -->
        ...
        <!-- DA constraints -->
        <!-- <a :['foo' + bar]="value"> ... </a> !!Error -->
        <!-- <a :[someAttr]="value"> ... </a> !!someAttr will become someattr when not in SFC-->
        <!-- Modifiers -->
